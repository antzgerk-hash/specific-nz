...
const projects: ProjectItem[] = [
  ...
  {
    id: "queenstown-hotel",
    name: "QT Queenstown (Rydges Lakeside Conversion)",
    client: "QT Hotels & Resorts",
    location: "Marine Parade, Queenstown, New Zealand",
    year: "2025–2026",
    scope: "Full FF&E Delivery, Assembly & Installation — Hotel Conversion",
    description:
      "Specific NZ delivered the complete FF&E installation programme for the conversion of the iconic Rydges Lakeside Queenstown into QT Queenstown — a full property refurbishment on the shores of Lake Wakatipu. The scope included full room fit-out across multiple floors, with custom joinery installation, arched mirror fitting, bespoke wardrobe and cabinetry installation, coat hook rail systems, and bench seating. The Specific team worked across active construction floors alongside the building envelope refurbishment, with scaffolding to the full exterior elevation throughout. Delivered to programme on one of Queenstown's most prominent lakefront properties.",
    hero: "/manus-storage/20260119_134405_49edc675.webp",
    images: [
      "/manus-storage/20260119_134405_49edc675.webp",
      "/manus-storage/20260126_121334_5338e433.webp",
      "/manus-storage/20250501_151030_17007ebf.webp",
      "/manus-storage/20250501_151053_92874ef3.webp",
    ...
    stats: [
      { value: "Full", label: "Hotel Conversion" },
      { value: "Lake", label: "Wakatipu Frontage" },
      { value: "Multi-Floor", label: "FF&E Installation" },
