...
const projects = [
  ...
  },
  {
    ...
    stats: [
      { value: "Multi", label: "Floor Hotel Installation" },
      { value: "Full", label: "Room FF&E Scope" },
      { value: "CBD", label: "Auckland Location" },
      { value: "IHG", label: "Brand Standard" },
    ],
    description: "Specific NZ delivered the full FF&E installation scope for Indigo Auckland, IHG's boutique lifestyle hotel brand in the Auckland CBD. The project involved the precision installation of complete room packages across multiple floors — beds, soft furnishings, joinery, desks, lighting, and all loose FF&E — to IHG's exacting brand standards. The Auckland CBD location presented access and programme challenges that Specific NZ's specialist teams managed without disruption to the construction programme.",
    images: [
  ...
  {
    id: "holiday-inn",
    name: "Holiday Inn Express Queenstown",
    client: "IHG Hotels & Resorts",
    location: "Queenstown, New Zealand",
    sector: "Hospitality / Hotel",
    year: "2024",
    scope: "FF&E Delivery & Installation",
    stats: [],
    description: "Full FF&E delivery and installation for Holiday Inn Express Queenstown, delivering IHG brand-standard room packages across the full hotel.",
    images: [],
